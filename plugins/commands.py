...
async def save_caption(client, message):
    ...
    try:
        ...
        return await message.reply_text("<b><u>ɪɴᴠᴀɪʟᴅ ꜰᴏʀᴍᴀᴛ!!</u>\n\nᴜsᴇ ʟɪᴋᴇ ᴛʜɪs - </b>\n<code>/caption Join [Here](https://t.me/Bot_Discussion_Group_amk)\n\nFILE : {file_name}\nSize : {file_size}</code>")
...
async def donation(bot, message):
    ...
    yt=await message.reply_photo(photo='https://telegra.ph/file/e717ffdfb2394774e44f1.jpg', caption=script.DONATE_TXT, reply_markup=InlineKeyboardMarkup(btn))
    await asyncio.sleep(300)
    await yt.delete()
